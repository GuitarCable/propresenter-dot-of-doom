...
void main(List<String> arguments) async {
  ...
  PcoApi pcoApi = new PcoApi(config['oAuth']['clientId'], config['oAuth']['clientSecret']);
  ...
  var teamApiResponse = await pcoApi.getAllTeamMembersForPlan(serviceTypeId, currentPlan['id']);
  ...
  for (dynamic player in players) {
    ...
    dynamic phoneNumberApiResponse = await pcoApi.getPhoneNumbersFromPersonId(playerId);
